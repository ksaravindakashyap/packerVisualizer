$(function () {
	...
	gradientStroke1.addColorStop(0, '#5797fc');
	gradientStroke1.addColorStop(1, '#5797fc');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, '#eb8888');
	gradientStroke2.addColorStop(1, '#eb7171');
   ...
   /* Chartjs (#revenue-by-channel) */
	...
	gradientStroke1.addColorStop(0, '#3671b5');
	gradientStroke1.addColorStop(1, '#c3b1e3');
