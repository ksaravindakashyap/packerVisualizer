					...
					<div class="box">
						...
						<div class="flexslider2">
						  <ul class="slides">
						    ...
						    <li data-thumb="assets/CN-2.png">
							    <div class="col-xl-12 col-12">
                					<div class="box">
				                		<div class="box-body">
                							<h4 class="box-title">Unique Sources & Destination [ipv4 & ipv6] count</h4>
				                			<div id="bar-chart" style="margin-top:100px"></div>
						                </div>
                					</div>
				                </div>
							</li>
							...
							<li data-thumb="assets/CN-1.png">
							    <div class="col-xl-12 col-12">
					                <div class="box">
						                <div class="box-body">
    		    					        <h4 class="box-title">All Protocols Count</h4>
	    		    				        <div id="donut-chart" style="color:#fff !important;margin-top:100px"></div>
		    				            </div>
					                </div>
				                </div>
							</li>
							...
							<li data-thumb="assets/CN-4.png">
							    <div class="col-xl-12 col-12">
                					<div class="box">
				                		<div class="box-body">
                							<h4 class="box-title">SUM(packet length) for TLSv1.2 Protocol From unique source</h4>
				                			<div id="line-chart" style="margin-top:100px"></div>
						                </div>
                					</div>
				                </div>
							</li>
...
<script>
    var line = new Morris.Line({
          ...
          data: [
              <?php
              $sql="SELECT DISTINCT(source) FROM `conn` WHERE `pid`='$pid'";
              $res = mysqli_query($conn,$sql);
              while($row=mysqli_fetch_assoc($res))
              {
                  $source=$row['source'];
                  $sum=mysqli_fetch_assoc(mysqli_query($conn,"SELECT SUM(length) AS su FROM data WHERE `pid`='$pid' AND `source`='$source'"));
                  $sum=$sum['su'];?>
                    {y: '<?php echo $source;?>', data1 : <?php echo $sum;?>},
            <?php
              }?>
    ...
    assets</script>	<script src="assets/vendor_plugins/bootstrap-slider/bootstrap-slider.js"></script>
